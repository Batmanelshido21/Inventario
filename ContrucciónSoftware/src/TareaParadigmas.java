...
public class TareaParadigmas {
    ...
    public static void main(String[] args) {
      ...
      System.out.println("Introduce el numero de las fracciones para comparar");
      ...
      int num2=lector.nextInt();
    	  ...
    	  System.out.println("Las posiciones de memoria son");
      System.out.println(fracciones.get(1).hashCode());
      System.out.println(fracciones.get(0).hashCode());
